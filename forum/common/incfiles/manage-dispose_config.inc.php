...
function jtbc_cms_admin_manage_transferdisp()
{
  global $conn;
  ...
  if ($tsort1 == 0 || $tsort2 == 0 || ii_isnull($tcondition)) jtbc_cms_admin_msg(ii_itake('manage-dispose.transfer_failed', 'lng'), $tbackurl, 1);
  else
  {
    ...
    if ($trs) jtbc_cms_admin_msg(ii_itake('manage-dispose.transfer_succeed', 'lng'), $tbackurl, 1);
...
function jtbc_cms_admin_manage_deletedisp()
{
  ...
  $tend_time = ii_get_safecode($_POST['end_time']);
  $tauthor = ii_get_safecode($_POST['author']);
  if ($tsort == 0 || ii_isnull($tcondition)) jtbc_cms_admin_msg(ii_itake('manage-dispose.delete_failed', 'lng'), $tbackurl, 1);
  else
  {
    ...
    jtbc_cms_admin_msg(ii_itake('manage-dispose.delete_succeed', 'lng'), $tbackurl, 1);
  }
}

function jtbc_cms_admin_manage_updatedisp()
{
  global $conn, $ngenre;
  global $ndatabase, $nidfield, $nfpre;
  $tbackurl = $_GET['backurl'];
  ...
  $tstart_time = ii_get_safecode($_POST['start_time']);
  $tend_time = ii_get_safecode($_POST['end_time']);
  if ($tsort == 0 || ii_isnull($tcondition)) jtbc_cms_admin_msg(ii_itake('manage-dispose.update_failed', 'lng'), $tbackurl, 1);
  else
  {
    ...
    jtbc_cms_admin_msg(ii_itake('manage-dispose.update_succeed', 'lng'), $tbackurl, 1);
  }
}
...
function jtbc_cms_admin_manage_action()
{
  ...
  {
    case 'transfer':
      jtbc_cms_admin_manage_transferdisp();
      break;
    case 'delete':
      jtbc_cms_admin_manage_deletedisp();
      break;
    case 'update':
      jtbc_cms_admin_manage_updatedisp();
      break;
  }
}
...
function jtbc_cms_admin_manage_transfer()
{
...
function jtbc_cms_admin_manage_update()
{
...
function jtbc_cms_admin_manage()
{
  ...
  {
    case 'transfer':
      return jtbc_cms_admin_manage_transfer();
      break;
    case 'delete':
      return jtbc_cms_admin_manage_delete();
      break;
    case 'update':
      return jtbc_cms_admin_manage_update();
      break;
    default:
      return jtbc_cms_admin_manage_transfer();
      break;
