...
function jtbc_cms_module_manage_topicdisp()
{
...
function jtbc_cms_module_manage_detaildisp()
{
  global $ndatabase, $nidfield, $nfpre;
  global $ncontrol;
...
function jtbc_cms_module_manage_blacklistdisp()
{
...
function jtbc_cms_module_manage_add_blacklistdisp()
{
  global $conn;
...
function jtbc_cms_module_topic_managedisp()
{
  ap_user_islogin();
  ...
  {
    case 'topic':
      jtbc_cms_module_manage_topicdisp();
      break;
    case 'detail':
      jtbc_cms_module_manage_detaildisp();
      break;
    case 'blacklist':
      jtbc_cms_module_manage_blacklistdisp();
      break;
    case 'add_blacklist':
      jtbc_cms_module_manage_add_blacklistdisp();
      break;
  }
}

function jtbc_cms_module_topic_releasedisp()
{
  global $ctype, $Err;
  $ctype = 'release';
  global $conn;
...
function jtbc_cms_module_topic_editdisp()
{
  global $ctype, $Err;
  $ctype = 'edit';
  global $conn;
...
function jtbc_cms_module_action()
{
  ...
  {
    case 'manage':
      jtbc_cms_module_topic_managedisp();
      break;
    case 'release':
      jtbc_cms_module_topic_releasedisp();
      break;
    case 'reply':
      jtbc_cms_module_topic_replydisp();
      break;
    case 'edit':
      jtbc_cms_module_topic_editdisp();
      break;
    case 'vote':
      jtbc_cms_module_topic_votedisp();
      break;
    case 'upload':
...
function jtbc_cms_module_manage()
{
  ...
  {
    case 'topic':
      return jtbc_cms_module_manage_topic();
      break;
    case 'detail':
      return jtbc_cms_module_manage_detail();
      break;
    case 'blacklist':
      return jtbc_cms_module_manage_blacklist();
      break;
    default:
      return jtbc_cms_module_manage_topic();
      break;
...
function jtbc_cms_module_index()
{
  ...
  while ($trow = ii_conn_fetch_array($trs))
  {
    ...
    $tmpstr2 = str_replace(JTBC_CINFO, $tmprstr2, $tmpstr2);
...
function jtbc_cms_module_topic_list()
{
  ...
  else
  {
    ...
    else $tmpastr = str_replace(JTBC_CINFO, $tmprstr2, $tmpastr);
    $tmpstr = str_replace(JTBC_CINFO, $tmpastr, $tmpstr);
...
function jtbc_cms_module_topic_detail()
{
  ...
  if ($tvoteid != 0)
  {
    ...
    if (is_array($tvoteary))
    {
      ...
      $tvotestr = str_replace(JTBC_CINFO, $tvoterstr, $tvotestr);
      ...
      $tmpstr = str_replace(JTBC_CINFO, $tvotestr, $tmpstr);
    }
...
function jtbc_cms_module_topic_reply()
{
  ap_user_islogin();
  global $nvalidate;
  $ttid = ii_get_num($_GET['tid']);
...
function jtbc_cms_module()
{
  ...
  {
    case 'manage':
      return jtbc_cms_module_manage();
      break;
    case 'list':
      return jtbc_cms_module_topic_list();
      break;
    case 'detail':
      return jtbc_cms_module_topic_detail();
      break;
    case 'release':
      return jtbc_cms_module_topic_release();
      break;
    case 'reply':
      return jtbc_cms_module_topic_reply();
      break;
    case 'edit':
      return jtbc_cms_module_topic_edit();
      break;
    case 'search':
      return jtbc_cms_module_search_list();
      break;
    case 'upload':
