...
function jtbc_cms_interface_get_index()
{
  $tmpstr = ii_ireplace('interface.index', 'tpl');
  echo $tmpstr;
}

function jtbc_cms_interface_get_list()
{
  $tmpstr = ii_ireplace('interface.list', 'tpl');
  echo $tmpstr;
}

function jtbc_cms_interface_get_detail()
{
  global $conn;
...
function jtbc_cms_interface_get()
{
  switch($_GET['mtype'])
  {
    case 'index':
      jtbc_cms_interface_get_index();
      break;
    case 'list':
      jtbc_cms_interface_get_list();
      break;
    case 'detail':
      jtbc_cms_interface_get_detail();
      break;
  }
}

function jtbc_cms_interface_create_index()
{
...
function jtbc_cms_interface_create_list()
{
...
function jtbc_cms_interface_create_detail()
{
  global $conn;
  global $n_database, $n_idfield, $n_fpre;
...
function jtbc_cms_interface_create()
{
  switch($_GET['mtype'])
  {
    case 'index':
      jtbc_cms_interface_create_index();
      break;
    case 'list':
      jtbc_cms_interface_create_list();
      break;
    case 'detail':
      jtbc_cms_interface_create_detail();
      break;
  }
}

function jtbc_cms_interface_loadsort()
{
...
function jtbc_cms_interface_loadsortlists()
{
  global $conn;
  global $n_database, $n_idfield, $n_fpre;
...
function jtbc_cms_interface_loadidminmax()
{
  global $conn;
  global $n_database, $n_idfield, $n_fpre;
  $tsort = ii_get_num($_GET['sort']);
...
function jtbc_cms_interface()
{
  ...
  {
    case 'get':
      jtbc_cms_interface_get();
      break;
    case 'create':
      jtbc_cms_interface_create();
      break;
    case 'loadsort':
      jtbc_cms_interface_loadsort();
      break;
    case 'loadsortlists':
      jtbc_cms_interface_loadsortlists();
      break;
    case 'loadidminmax':
      jtbc_cms_interface_loadidminmax();
      break;
  }
}
//****************************************************
